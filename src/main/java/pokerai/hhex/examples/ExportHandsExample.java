...
public class ExportHandsExample {
  ...
  public static void main(String[] args) {
    String rootfolder = "/Users/willrubens/dev/poker-hhdb/hhdb_sample/";
    ...
    for (int i = 0; i < all.length; i++) {
      //if (all[i].startsWith("pokerai.org.sample" + Consts.SITE_PS + "_" + Consts.HOLDEM_NL + "_9") && all[i].endsWith(".hhex")) {
